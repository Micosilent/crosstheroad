...
<h3 align="center">Cross The Road</h3>

  <p align="center">
    A frogger clone made in python
...
Simply download the repo and run main.py
```sh
    python3 main.py
```
...
Pau Costa - pau@micodev.es

Project Link: [https://github.com/Micosilent/crosstheroad](https://github.com/Micosilent/crosstheroad)
...
[product-screenshot]: readme_demo.webp
